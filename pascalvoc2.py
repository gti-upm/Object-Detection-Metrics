...
for metricsPerClass in detections:
    ...
    mean_det_iou = statistics.mean(max_iou)
    std_det_iou = statistics.stdev(max_iou)
    ...
    if totalPositives > 0:
        ...
        f.write('\nMean detection iou: %s' % mean_det_iou)
        f.write('\nStandard deviation of detection iou: %s' % std_det_iou)
